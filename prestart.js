sc.PARTY_OPTIONS.push("Kit");


//ig.module("game.feature.party.party-steps-emilie2Mod").requires("impact.base.action", "impact.base.event", "game.feature.party.party").defines(function () {
